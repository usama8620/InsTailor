...
public class WomenPantsCutFragment extends Fragment {

    public WomenPantsCutFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_women_pants_cut, container, false);
