...
public class SolidShirtsFragment extends Fragment {
    private List<Shopping> SolidShoppingList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_solid_shirts, container, false);
        ...
        mSlimAdapter = SlimAdapter.create()
                    ...
                    public void onInject(final Shopping data, IViewInjector injector) {
                        ...
                        injector.clicked(R.id.allstylesshirt_wishlist_image, new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                wishListitem.setItem_type("Solid");
                ...
                .attachTo(mRecyclerView).updateData(SolidShoppingList);
    ...
    private void prepareSolidShoppingData() {
        ...
        SolidShoppingList.add(shopping);
        ...
        SolidShoppingList.add(shopping);
        mSlimAdapter.updateData(SolidShoppingList);
