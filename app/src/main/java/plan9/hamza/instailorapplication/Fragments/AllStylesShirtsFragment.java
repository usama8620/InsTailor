...
public class AllStylesShirtsFragment extends Fragment {
    ...
    public AllStylesShirtsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_all_styles_shirts, container, false);
