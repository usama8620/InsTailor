...
public class WomenShirtsLengthFragment extends Fragment {

    public WomenShirtsLengthFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_women_shirts_length, container, false);
