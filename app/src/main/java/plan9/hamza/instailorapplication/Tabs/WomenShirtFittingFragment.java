...
public class WomenShirtFittingFragment extends Fragment {

    public WomenShirtFittingFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_women_shirt_fitting, container, false);
