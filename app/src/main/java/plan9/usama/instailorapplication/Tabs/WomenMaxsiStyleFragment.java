...
public class WomenMaxsiStyleFragment extends Fragment {

    public WomenMaxsiStyleFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_women_maxsi_style, container, false);
