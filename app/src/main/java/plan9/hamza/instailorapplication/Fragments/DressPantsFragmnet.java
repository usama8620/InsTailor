...
public class DressPantsFragmnet extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_dress_pants_fragmnet, container, false);
                    ...
                    public void onInject(final Shopping data, IViewInjector injector) {
                        ...
                        injector.clicked(R.id.allstylesshirt_wishlist_image, new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                wishListitem.setItem_type("Dress Pants Trouser");
    ...
    private void prepareAllStylesShoppingData() {
        Shopping shopping = new Shopping("MenTrousers1", R.mipmap.shrt2);
        AllStylesShoppingList.add(shopping);
        shopping = new Shopping("MenTrousers2", R.mipmap.shrt2);
        AllStylesShoppingList.add(shopping);
        shopping = new Shopping("MenTrousers3", R.mipmap.shrt2);
        AllStylesShoppingList.add(shopping);
        shopping = new Shopping("MenTrousers4", R.mipmap.shrt2);
        AllStylesShoppingList.add(shopping);
        shopping = new Shopping("MenTrousers5", R.mipmap.shrt2);
        AllStylesShoppingList.add(shopping);
        shopping = new Shopping("MenTrousers6", R.mipmap.shrt2);
        AllStylesShoppingList.add(shopping);
        shopping = new Shopping("MenTrousers7", R.mipmap.shrt2);
        AllStylesShoppingList.add(shopping);
        shopping = new Shopping("MenTrousers8", R.mipmap.shrt2);
        AllStylesShoppingList.add(shopping);
        shopping = new Shopping("MenTrousers9", R.mipmap.shrt2);
        AllStylesShoppingList.add(shopping);
