...
public class WomenTrousersLengthFragment extends Fragment {

    public WomenTrousersLengthFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_women_trousers_length, container, false);
