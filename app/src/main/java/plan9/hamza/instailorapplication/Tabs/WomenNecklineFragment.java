...
public class WomenNecklineFragment extends Fragment {

    public WomenNecklineFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_women_neckline, container, false);
