...
public class WomenPantsThreadFragment extends Fragment {

    public WomenPantsThreadFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_women_pants_thread, container, false);
