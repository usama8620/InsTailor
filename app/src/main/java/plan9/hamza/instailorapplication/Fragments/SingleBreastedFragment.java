...
public class SingleBreastedFragment extends Fragment {
    private List<Shopping> SuitsShoppingList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_single_breasted, container, false);
        ...
        mSlimAdapter = SlimAdapter.create()
                    ...
                    public void onInject(final Shopping data, IViewInjector injector) {
                        ...
                        injector.clicked(R.id.allstylesshirt_wishlist_image, new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                wishListitem.setItem_type("Single Breasted Suit");
                ...
                .attachTo(mRecyclerView).updateData(SuitsShoppingList);
    ...
    private void prepareSolidShoppingData() {
        Shopping shopping = new Shopping("MenSuit1", R.mipmap.shrt2);
        SuitsShoppingList.add(shopping);
        shopping = new Shopping("MenSuit2", R.mipmap.shrt2);
        SuitsShoppingList.add(shopping);
        shopping = new Shopping("MenSuit3", R.mipmap.shrt2);
        SuitsShoppingList.add(shopping);
        shopping = new Shopping("MenSuit4", R.mipmap.shrt2);
        SuitsShoppingList.add(shopping);
        shopping = new Shopping("MenSuit5", R.mipmap.shrt2);
        SuitsShoppingList.add(shopping);
        shopping = new Shopping("MenSuit6", R.mipmap.shrt2);
        SuitsShoppingList.add(shopping);
        shopping = new Shopping("MenSuit7", R.mipmap.shrt2);
        SuitsShoppingList.add(shopping);
        shopping = new Shopping("MenSuit8", R.mipmap.shrt2);
        SuitsShoppingList.add(shopping);
        shopping = new Shopping("MenSuit9", R.mipmap.shrt2);
        SuitsShoppingList.add(shopping);
        mSlimAdapter.updateData(SuitsShoppingList);
