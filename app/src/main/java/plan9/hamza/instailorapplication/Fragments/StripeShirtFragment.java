...
public class StripeShirtFragment extends Fragment {
    private List<Shopping> StripeShirtList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_stripe_shirt, container, false);
        ...
        mSlimAdapter = SlimAdapter.create()
                    ...
                    public void onInject(final Shopping data, IViewInjector injector) {
                        ...
                        injector.clicked(R.id.allstylesshirt_wishlist_image, new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                wishListitem.setItem_type("Stripe Shirt");
                ...
                .attachTo(mRecyclerView).updateData(StripeShirtList);
    ...
    private void prepareAllStylesShoppingData() {
        Shopping shopping = new Shopping("MenStripeShirts1", R.mipmap.men);
        StripeShirtList.add(shopping);
        shopping = new Shopping("MenStripeShirts2", R.mipmap.men);
        StripeShirtList.add(shopping);
        shopping = new Shopping("MenStripeShirts3", R.mipmap.men);
        StripeShirtList.add(shopping);
        shopping = new Shopping("MenStripeShirts4", R.mipmap.men);
        StripeShirtList.add(shopping);
        shopping = new Shopping("MenStripeShirts5", R.mipmap.men);
        StripeShirtList.add(shopping);
        shopping = new Shopping("MenStripeShirts6", R.mipmap.men);
        StripeShirtList.add(shopping);
        shopping = new Shopping("MenStripeShirts7", R.mipmap.men);
        StripeShirtList.add(shopping);
        shopping = new Shopping("MenStripeShirts8", R.mipmap.men);
        StripeShirtList.add(shopping);
        shopping = new Shopping("MenStripeShirts9", R.mipmap.men);
        StripeShirtList.add(shopping);
        mSlimAdapter.updateData(StripeShirtList);
