...
public class WomenLehngaSleevesFragment extends Fragment {

    public WomenLehngaSleevesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_women_lehnga_sleeves, container, false);
