...
public class KnickersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_knickers, container, false);
                    ...
                    public void onInject(final Shopping data, IViewInjector injector) {
                        ...
                        injector.clicked(R.id.allstylesshirt_wishlist_image, new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                wishListitem.setItem_type("Knickers Trouser");
