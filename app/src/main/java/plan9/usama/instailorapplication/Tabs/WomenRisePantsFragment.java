...
public class WomenRisePantsFragment extends Fragment {

    public WomenRisePantsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_women_rise_pants, container, false);
