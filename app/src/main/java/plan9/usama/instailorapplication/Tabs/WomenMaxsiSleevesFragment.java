...
public class WomenMaxsiSleevesFragment extends Fragment {

    public WomenMaxsiSleevesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_women_maxsi_sleeves, container, false);
